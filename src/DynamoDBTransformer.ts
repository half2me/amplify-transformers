...
import { obj, str, ref, print, compoundExpression, ifElse, methodCall, toJson, set } from 'graphql-mapping-template'
...
class DynamoDBTransformer extends Transformer {
  ...
  func = (table: string, field: string, type: string, name: string): AppSync.FunctionConfiguration => {
